...
class ARNode {
  ...
  set position(Vector3 value) {
    final Matrix4 old = Matrix4.fromFloat64List(transform.storage);
    final Matrix4 newT = old.clone();
  ...
  static const MatrixValueNotifierConverter _matrixValueNotifierConverter = MatrixValueNotifierConverter();
...
Matrix4 createTransformMatrix(Matrix4? origin, Vector3? position,
  ...
  final Matrix4 transform = origin ?? Matrix4.identity();
...
extension Matrix4Extenstion on Matrix4 {
  ...
  Vector3 get matrixEulerAngles {
    final Quaternion q = Quaternion(0, 0, 0, 0);
    ...
    final Vector3 angles = Vector3.zero();
  ...
  set matrixEulerAngles(Vector3 angles) {
    ...
    final Quaternion r = Quaternion.euler(angles[0], angles[1], angles[2]);
