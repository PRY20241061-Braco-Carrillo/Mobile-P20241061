  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ElevatedButton(
      onPressed: menuData != null && buttonEnabled
          ? () {
              final MenuDetailVariantCard? initialDishVariant = ref
                  .read(selectedInitialDishesVariantsProvider)
                  .selectedVariant;
              final MenuDetailVariantCard? principalDishVariant = ref
                  .read(selectedPrincipalDishesVariantsProvider)
                  .selectedVariant;
              final MenuDetailVariantCard? drinkVariant =
                  ref.read(selectedDrinksVariantsProvider).selectedVariant;
              final MenuDetailVariantCard? dessertVariant =
