...
import "menu_base.types.dart";

class CMenuBaseCard extends StatelessWidget {
  ...
  const CMenuBaseCard.skeleton({super.key})
      : data = null,
        error = null,
        showSkeleton = true,
  ...
  const CMenuBaseCard.error({super.key, required this.error})
      : data = null,
        showSkeleton = false,
        categoryNavigationData = null,
        campusCardData = null;
