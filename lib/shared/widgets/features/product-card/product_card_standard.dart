...
class CMenuCardStandard extends StatelessWidget {
  final MenuCardData? data;
  final bool showSkeleton;
  final String? error;

  const CMenuCardStandard({super.key, required this.data})
      : showSkeleton = false,
        error = null;

  const CMenuCardStandard.skeleton({super.key})
      : data = null,
        error = null,
        showSkeleton = true;

  const CMenuCardStandard.error({super.key, required this.error})
      : data = null,
        showSkeleton = false;
