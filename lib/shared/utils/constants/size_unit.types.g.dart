...
const Map<WeightUnit, String> _$WeightUnitEnumMap = <WeightUnit, String>{
  WeightUnit.kg: "kg",
  WeightUnit.g: "g",
};
...
const Map<VolumeUnit, String> _$VolumeUnitEnumMap = <VolumeUnit, String>{
  VolumeUnit.l: "l",
  VolumeUnit.ml: "ml",
  VolumeUnit.cm3: "cm3",
  VolumeUnit.in3: "in3",
...
const Map<SizeDescription, String> _$SizeDescriptionEnumMap = <SizeDescription, String>{
