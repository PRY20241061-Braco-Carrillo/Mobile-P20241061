...
import "../../../shared/widgets/features/product-card/promotions/promotions_base-card/promotion_base.dart";
import "../../../shared/widgets/features/product-card/promotions/promotions_base-card/promotion_base.types.dart";
import "../../../shared/widgets/features/product-card/promotions/promotions_compact-card/promotion_compact.dart";
...
class PromotionsDetailScreen extends ConsumerStatefulWidget {
  final CampusCardData campusCardData;

  const PromotionsDetailScreen({super.key, required this.campusCardData});

  @override
  PromotionsDetailScreenState createState() => PromotionsDetailScreenState();
}

class PromotionsDetailScreenState extends ConsumerState<PromotionsDetailScreen>
